...
// import 'jest-location-mock'; // Vitest supports Jest mocks
import App from './App';
...
// Mock the modules for PieChart rendering as they require a transformer being used (not done by Vitest by default)
...
describe('Testing the App Component', () => {
  it('Component should be rendered properly and user is logged in', async () => {
    // Uncomment and replace `useLocalStorage` if necessary
